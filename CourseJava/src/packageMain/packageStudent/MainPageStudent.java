package packageMain.packageStudent;
...
import packageMain.packageUniffied.MainPageQuizz;
...
public class MainPageStudent extends JFrame {
	...
	public void all() {
		...
		mathButton.setIcon(new ImageIcon(MainPageStudent.class.getResource("/packageMain/icons8_math_25px.png")));
		...
		programmingButton.setIcon(new ImageIcon(MainPageStudent.class.getResource("/packageMain/icons8_code_25px.png")));
		programmingButton.setSelectedIcon(new ImageIcon(MainPageStudent.class.getResource("/packageMain/icons8_code_25px.png")));
		...
		englishButton.setIcon(new ImageIcon(MainPageStudent.class.getResource("/packageMain/icons8_language_filled_25px.png")));
		...
		btnQuizz.setIcon(new ImageIcon(MainPageStudent.class.getResource("/packageMain/icons8_test_filled_25px.png")));
		...
		btnMyProfile.setIcon(new ImageIcon(MainPageStudent.class.getResource("/packageMain/icons8_admin_settings_male_filled_25px.png")));
