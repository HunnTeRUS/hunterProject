...
public class EnglishQuestions {
	...
	public static ArrayList<String> correctAnswerEnglish = new ArrayList<String>();
	...
	public void addQuestions(String question, String  correctAnwser, String answerReceived2, String answerReceived3,
		...
		correctAnswerEnglish.add(correctAnwser);
		...
		if(db.getConnection()) {
			try {
				SQL = "INSERT INTO mathExercises (question, correctAnswer, answer2, answer3, answer4, explanation)Values('" +
						questionsEnglish.get(questionsEnglish.size()-1) + "', '" + correctAnswerEnglish.get(correctAnswerEnglish.size()-1) + "' , '" 
