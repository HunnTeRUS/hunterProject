...
public class MainPageAdm extends JFrame {
	...
	public void all() {
		...
		programmingButton
				.setSelectedIcon(new ImageIcon(MainPageAdm.class.getResource("/packageMain/icons8_code_25px.png")));
		...
		englishButton
				.setIcon(new ImageIcon(MainPageAdm.class.getResource("/packageMain/icons8_language_filled_25px.png")));
		...
		btnMyProfile.setIcon(new ImageIcon(
				MainPageAdm.class.getResource("/packageMain/icons8_admin_settings_male_filled_25px.png")));
